...
# and it is also a good language to have in any programmer’s stack as it can be used for everything
# from web development to software development and scientific applications.
# Python also works on different platforms (Windows, Mac, Linux, Raspberry Pi, etc).
